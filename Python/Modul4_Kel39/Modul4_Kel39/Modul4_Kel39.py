...
#Pemanggilan Fungsi
non_return_func("Iqbal", "Ahmad")
return_func(1)
anonim_func("iqbal", "ahmad", 5)
arbitrary_func("nama 1", "nama 2", "nama 3", "nama 4")

#objek baru method
p1 = percobaan2.contoh_method("boy","tg")

#pemanggilan method dgn self parameter
p1.mulai()

#pemanggilan method dgn parameter
p1.selesai(3)
